...
void Level::initLevel()
{
    ...
    case Game::EGameMode::OnePlayer:
        m_pTank1 = std::make_shared<Tank>(Tank::ETankType::EnemyRed_type1, false, true, Tank::EOrientation::Top, 0.05, getPlayerRespawn_1(), glm::vec2(Level::BLOCK_SIZE, Level::BLOCK_SIZE), 0.f);
        Physics::PhysicsEngine::addDynamicGameObject(m_pTank1);
    }

    m_enemyTanks.emplace(std::make_shared<Tank>(Tank::ETankType::Player2Green_type1, true, false, Tank::EOrientation::Bottom, 0.05, getEnemyRespawn_1(), glm::vec2(Level::BLOCK_SIZE, Level::BLOCK_SIZE), 0.f));
    ...
    m_enemyTanks.emplace(std::make_shared<Tank>(Tank::ETankType::Player1Yellow_type3, true, false, Tank::EOrientation::Bottom, 0.05, getEnemyRespawn_3(), glm::vec2(Level::BLOCK_SIZE, Level::BLOCK_SIZE), 0.f));
